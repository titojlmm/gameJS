...
  this.push(this.angle, (this.thruster_on - this.retro_on) * this.thruster_power, elapsed);
  // Si están ambos o ninguno activo no hay giro. En caso contrario gira hacia el activo
...
    this.rotation_speed
  );
  // Se inicializa el tiempo de recarga para el siguiente proyectil
  this.time_until_reloaded = this.weapon_reload_time;
  // Tercera ley de Newton: fuerza de los proyectiles y retroceso de la nave
